import svgPaths from "./svg-1354frslez";
  ...
  return (
    <div className="relative shrink-0 size-[59.2px]" data-name="Back Button">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 59.2 59.2">
        ...
        <defs>
          <clipPath id="bgblur_0_11_3674_clip_path" transform="translate(37 37)">
...
function Header() {
  return (
    <div className="content-stretch flex gap-[1526.25px] items-center justify-center max-w-[370px] relative shrink-0 w-[370px]" data-name="Header">
      <BackButton />
      <RoundTimeInfo />
    </div>
  );
...
function LevelBadge() {
  return (
    <div className="bg-[rgba(255,192,19,0.12)] content-stretch flex items-start justify-between px-[12px] py-[8px] relative rounded-[8px] shrink-0 w-[182px]" data-name="LevelBadge">
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[51px] h-[1037px] items-start justify-center pb-[418px] relative shrink-0 w-[1852px]">
      <StateBar />
      <Frame1 />
    </div>
  );
...
function WordContainer() {
  return (
    <div className="content-stretch flex h-[1036px] items-center justify-center px-[32.49px] relative rounded-[20.306px] shrink-0 w-[1856px]" data-name="Word Container">
      <Frame2 />
    </div>
  );
}
...
function SelectButtonContainer() {
  return (
    <div className="bg-[#141414] content-stretch flex h-[65.1px] items-center justify-center max-w-[333.84600830078125px] overflow-clip p-[6.677px] relative rounded-[10.015px] shrink-0 w-[333.846px]" data-name="Select Button Container">
...
function ContentContainer() {
  return (
    <div className="bg-[rgba(255,255,255,0.7)] content-stretch flex flex-col h-[1240px] items-center max-w-[1920px] relative rounded-[20px] shrink-0 w-full" data-name="Content Container">
      <BadgeContainer />
      <WordContainer />
...
function Footer() {
  return (
    <div className="content-stretch flex gap-[27px] items-center justify-center relative shrink-0 w-[774px]" data-name="Footer">
...
export default function Component1F() {
  return (
    <div className="bg-gradient-to-t content-stretch flex flex-col from-[#ffc013] gap-[42px] items-center pb-[20px] pt-[44px] px-[12px] relative size-full to-[#fff9e4]" data-name="1F">
      <Header />
      <ContentContainer />
      <Footer />
    </div>
