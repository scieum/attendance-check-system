...
function Header() {
  return (
    <div className="h-[444px] relative shrink-0 w-full" data-name="Header">
...
function DifficultyContainer() {
  return (
    <div className="content-stretch flex flex-col h-[760px] items-center relative shrink-0 w-full" data-name="Difficulty Container">
      <DifficultyOptions />
    </div>
  );
}
