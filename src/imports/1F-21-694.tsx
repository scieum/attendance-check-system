import svgPaths from "./svg-gd55q8d204";
...
function BadgeContainer() {
  return (
    <div className="content-stretch flex flex-col h-[93px] items-start justify-center mb-[-65.1px] px-[20px] py-[24px] relative shrink-0 w-[1880px]" data-name="Badge Container">
      <LevelBadge />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[36px] h-[683px] items-start justify-center pb-[103px] pt-[35px] relative shrink-0 w-[1852px]">
      <StateBar />
      <Frame1 />
    </div>
  );
...
function WordContainer() {
  return (
    <div className="content-stretch flex h-[739px] items-center justify-center mb-[-65.1px] px-[32.49px] relative rounded-[20.306px] shrink-0 w-[1856px]" data-name="Word Container">
      <Frame2 />
    </div>
  );
}
...
function SelectButtonContainer() {
  return (
    <div className="bg-[#141414] content-stretch flex h-[65.1px] items-center justify-center max-w-[333.84600830078125px] mb-[-65.1px] overflow-clip p-[6.677px] relative rounded-[10.015px] shrink-0 w-[333.846px]" data-name="Select Button Container">
...
function ContentContainer() {
  return (
    <div className="bg-[rgba(255,255,255,0.7)] content-stretch flex flex-col h-[784px] items-center max-w-[1920px] pb-[65.1px] relative rounded-[20px] shrink-0 w-full" data-name="Content Container">
      <BadgeContainer />
      <WordContainer />
