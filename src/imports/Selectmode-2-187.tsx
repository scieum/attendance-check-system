...
function Header() {
  return (
    <div className="h-[397px] relative shrink-0 w-full" data-name="Header">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center pb-[67px] px-[10px] relative size-full">
...
function DifficultyContainer() {
  return (
    <div className="content-stretch flex flex-col h-[768px] items-center relative shrink-0 w-full" data-name="Difficulty Container">
      <DifficultyOptions />
    </div>
  );
}
