import svgPaths from "./svg-4wcy67qoze";
...
function AlarmInfo() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">64번</p>
      <Frame />
    </div>
  );
}
...
function AlarmInfo1() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">65번</p>
      <Frame3 />
    </div>
  );
}
...
function AlarmInfo2() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">66번</p>
      <Frame6 />
    </div>
  );
}
...
function AlarmInfo3() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">67번</p>
      <Frame7 />
    </div>
  );
}
...
function AlarmInfo4() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">68번</p>
      <Frame8 />
    </div>
  );
}
...
function AlarmInfo5() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">69번</p>
      <Frame9 />
    </div>
  );
}
...
function AlarmInfo6() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">70번</p>
      <Frame10 />
    </div>
  );
}
...
function AlarmInfo7() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">71번</p>
      <Frame11 />
    </div>
  );
}
...
function AlarmInfo8() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">72번</p>
      <Frame12 />
    </div>
  );
}
...
function AlarmInfo9() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">73번</p>
      <Frame13 />
    </div>
  );
}
...
function AlarmInfo10() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">74번</p>
      <Frame14 />
    </div>
  );
}
...
function AlarmInfo11() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">75번</p>
      <Frame15 />
    </div>
  );
}
...
function AlarmInfo12() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">76번</p>
      <Frame16 />
    </div>
  );
}
...
function AlarmInfo13() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">77번</p>
      <Frame17 />
    </div>
  );
}
...
function Seat1() {
  return (
    <div className="content-stretch flex gap-[27px] items-center relative shrink-0 w-[1755px]" data-name="Seat 1">
      <Seat />
      <Seat2 />
      <Seat3 />
      <Seat4 />
...
function AlarmInfo14() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">63번</p>
      <Frame18 />
    </div>
  );
}
...
function Seat15() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Seat 2">
      <Seat16 />
    </div>
  );
}
...
function AlarmInfo15() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">62번</p>
      <Frame19 />
    </div>
  );
}
...
function AlarmInfo16() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">61번</p>
      <Frame20 />
    </div>
  );
}
...
function Seat19() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Seat 5">
      <Seat20 />
    </div>
  );
}
...
function AlarmInfo17() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">60번</p>
      <Frame21 />
    </div>
  );
}
...
function Seat21() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Seat 6">
      <Seat22 />
    </div>
  );
}
...
function AlarmInfo18() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">59번</p>
      <Frame22 />
    </div>
  );
}
...
function AlarmInfo19() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">58번</p>
      <Frame23 />
    </div>
  );
}
...
function AlarmInfo20() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">57번</p>
      <Frame24 />
    </div>
  );
}
...
function AlarmInfo21() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">56번</p>
      <Frame25 />
    </div>
  );
}
...
function AlarmInfo22() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">55번</p>
      <Frame26 />
    </div>
  );
}
...
function AlarmInfo23() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">54번</p>
      <Frame27 />
    </div>
  );
}
...
function AlarmInfo24() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">53번</p>
      <Frame28 />
    </div>
  );
}
...
function AlarmInfo25() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">52번</p>
      <Frame29 />
    </div>
  );
}
...
function AlarmInfo26() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">51번</p>
      <Frame30 />
    </div>
  );
}
...
function AlarmInfo27() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">50번</p>
      <Frame31 />
    </div>
  );
}
...
function AlarmInfo28() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:ExtraBold',sans-serif] gap-[12.681px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full" data-name="Alarm Info">
      <p className="relative shrink-0 text-[18px] w-[59px]">49번</p>
      <Frame32 />
    </div>
  );
}
...
function Seat23() {
  return (
    <div className="content-stretch flex gap-[27px] items-center relative shrink-0" data-name="Seat 3">
      <Seat24 />
      <Seat25 />
      <Seat26 />
      <Seat27 />
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[11px] items-start justify-center relative shrink-0">
      <Seat1 />
      <Seat15 />
      <Seat17 />
      <Seat19 />
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[36px] h-[777px] items-start justify-center mb-[-25px] pb-[54px] pt-[22px] relative shrink-0 w-[1852px]">
      <StateBar />
      <Frame1 />
    </div>
  );
...
function SelectButtonContainer() {
  return (
    <div className="bg-[#141414] content-stretch flex h-[65.1px] items-center justify-center max-w-[333.84600830078125px] mb-[-25px] overflow-clip p-[6.677px] relative rounded-[10.015px] shrink-0 w-[333.846px]" data-name="Select Button Container">
...
function ContentContainer() {
  return (
    <div className="bg-[rgba(255,255,255,0.7)] content-stretch flex flex-col h-[840px] items-center max-h-[840px] max-w-[1896px] pb-[25px] relative rounded-[20px] shrink-0 w-[1896px]" data-name="Content Container">
      <Frame2 />
...
function Footer() {
  return (
    <div className="content-stretch flex gap-[27px] h-[85px] items-center justify-center relative shrink-0 w-[774px]" data-name="Footer">
...
export default function Component2F() {
  return (
    <div className="bg-gradient-to-t content-stretch flex flex-col from-[#31a9ff] gap-[20px] items-center pb-[100px] pt-[27px] px-[12px] relative size-full to-[#e3f3ff]" data-name="2F">
      <Frame4 />
      <ContentContainer />
      <Footer />
    </div>
