import svgPaths from "./svg-fecptsilx6";
...
function SelectButtonContainer() {
  return (
    <div className="bg-[#141414] h-[78px] max-w-[400px] relative rounded-[12px] shrink-0 w-full" data-name="Select Button Container">
      <div className="flex flex-row items-center justify-center max-w-[inherit] overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center justify-center max-w-[inherit] p-[8px] relative size-full">
          <p className="font-['Pretendard:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[35px] text-white whitespace-nowrap">전송하기</p>
        </div>
      </div>
    </div>
  );
