import svgPaths from "./svg-7g4rs48t2v";
...
function LevelBadge() {
  return (
    <div className="bg-[rgba(255,192,19,0.12)] content-stretch flex items-start justify-between px-[12px] py-[8px] relative rounded-[8px] shrink-0 w-[120px]" data-name="LevelBadge">
      <p className="font-['NanumSquare:ExtraBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#ffc013] text-[30px] whitespace-nowrap">하수모드</p>
    </div>
  );
}
...
function LevelBadge1() {
  return (
    <div className="bg-[rgba(255,192,19,0.12)] content-stretch flex items-center justify-center px-[12px] py-[8px] relative rounded-[8px] shrink-0" data-name="LevelBadge">
      <p className="font-['NanumSquare:ExtraBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#ffc013] text-[20px] whitespace-nowrap">3학년</p>
    </div>
  );
}
...
function BadgeContainer1() {
  return (
    <div className="relative shrink-0 w-full" data-name="Badge Container">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[20px] py-[24px] relative w-full">
          <LevelBadge1 />
        </div>
      </div>
    </div>
...
function Component() {
  return (
    <div className="relative shrink-0 size-[120px]" data-name="피피팀">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 120 120">
        <g id="í¼í¼í">
          <path d={svgPaths.p188ae9f1} fill="url(#paint0_linear_7_573)" id="Vector" />
          <path d={svgPaths.p6e33400} fill="url(#paint1_linear_7_573)" id="Vector_2" />
          <circle cx="50.9094" cy="54.8494" fill="var(--fill-0, #E9E9E9)" id="Ellipse 4" r="4.80557" />
          <path d={svgPaths.p3e4b8240} fill="var(--fill-0, #D8D8D8)" id="Vector_3" />
          <path d={svgPaths.pecaa000} fill="var(--fill-0, #B7BBE8)" id="Vector_4" />
          <circle cx="70.6646" cy="54.8486" fill="var(--fill-0, #E9E9E9)" id="Ellipse 3" r="4.80557" />
          <path d={svgPaths.p6479800} fill="var(--fill-0, #737FF1)" id="Vector_5" opacity="0.6" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_7_573" x1="59.9286" x2="59.9286" y1="24.5998" y2="102.998">
            <stop offset="0.00903746" stopColor="#4359CE" />
            <stop offset="0.330948" stopColor="#7F83DC" />
            <stop offset="1" stopColor="#51BFC5" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_7_573" x1="54.0305" x2="67.0653" y1="25.0939" y2="102.401">
            <stop offset="0.00903746" stopColor="#4359CE" />
            <stop offset="0.735577" stopColor="#49BABD" />
          </linearGradient>
        </defs>
      </svg>
    </div>
...
function FooterTextContainer() {
  return (
    <div className="bg-white content-stretch flex gap-[10px] items-center justify-center p-[16px] relative rounded-[14px] shadow-[0px_0px_12px_0px_rgba(0,0,0,0.12)] shrink-0" data-name="Footer Text Container">
      <p className="font-['NanumSquareOTF_ac:ExtraBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black whitespace-nowrap">세가지를 말해봐!</p>
...
function Footer() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-[284px]" data-name="Footer">
      <Component />
      <FooterTextContainer />
    </div>
  );
